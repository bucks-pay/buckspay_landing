        ...
        <div className={styles.container}>
            <div onClick={toggleDropdown} className={styles.selected}>
                {selectedLanguage === 'en' ? (
                    ...
                    <>
                        <Image src={"/icons/colombia.png"} alt='colombia' width={30} height={16} />
            ...
            {isOpen && (
                <ul className={styles.dropdown}>
                    <li onClick={() => handleLanguageChange('en')} className={styles.option}>
                        <Image src={"/icons/usa.png"} alt='usa' width={30} height={16} />
                        <span >English</span>
                    </li>
                    <li onClick={() => handleLanguageChange('es')} className={styles.option}>
                        <Image src={"/icons/colombia.png"} alt='colombia' width={30} height={16} />
                        <span >Español</span>
                    </li>
                </ul>
